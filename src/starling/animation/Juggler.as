...
package starling.animation
{
    ...
    public class Juggler implements IAnimatable
    {
        ...
        public function delayCall(call:Function, delay:Number, ...args):uint
        {
            ...
            var delayedCall:DelayedCall = DelayedCall./*starling_internal*/ public::fromPool(call, delay, args);
        ...
        public function repeatCall(call:Function, interval:Number, repeatCount:int=0, ...args):uint
        {
            ...
            var delayedCall:DelayedCall = DelayedCall./*starling_internal*/ public::fromPool(call, interval, args);
        ...
        {
            DelayedCall./*starling_internal*/ public::toPool(event.target as DelayedCall);
        }
        ...
        public function tween(target:Object, time:Number, properties:Object):uint
        {
            ...
            var tween:Tween = Tween./*starling_internal*/ public::fromPool(target, time);
        ...
        {
            Tween./*starling_internal*/ public::toPool(event.target as Tween);
        }
